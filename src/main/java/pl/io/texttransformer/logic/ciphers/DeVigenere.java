...
/**
 * Deciphers input text using Vigenere cipher with key "VIGENERE".
 */
public class DeVigenere extends Transformation {
     ...
     */
    public DeVigenere(Transformation transformation) {
    ...
    public String transform(String text) {
        ...
        for (int i = 0; i < text.length(); i++) {
            if(Character.isLetter(textUpper.charAt(i))){
                int x = (textUpper.charAt(i) - key.charAt(i)+26) % 26;
                x += 'A';
